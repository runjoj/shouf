...
const SECTION_COLORS: Record<string, string> = {
  ...
  "problem & context": "var(--shouf-accent-rose)",
  "process":           "var(--shouf-accent-blue)",
  "project setup":     "var(--shouf-accent)",
  "user profile":      "var(--shouf-accent)",
  "features & tests":  "var(--shouf-accent)",
  "guided walkthrough":"var(--shouf-accent-sage)",
  "reflection":        "var(--shouf-text-muted)",
