...
function getTokens(values: ComponentControlValues): TokenRow[] {
  ...
  return [
    // ── Visual / variant tokens
    {
      ...
      property: "background",
      cssValue: vv.bg,
      tokenName: `--shouf-btn-${variant}-bg`,
      category: "color",
    },
    {
      id: "color",
      property: "color",
      cssValue: vv.color,
      tokenName: `--shouf-btn-${variant}-color`,
      category: "color",
    },
    {
      id: "border",
      ...
      cssValue: vv.border,
      tokenName: `--shouf-btn-${variant}-border`,
      category: "color",
    },
    {
      id: "shadow",
      property: "box-shadow",
      cssValue: vv.shadow,
      tokenName: `--shouf-btn-${variant}-shadow`,
      category: "shadow",
    },
    // ── Size tokens
    {
    ...
    },
    {
      ...
      cssValue: sv.radius,
      tokenName: `--shouf-btn-radius-${size}`,
      category: "radius",
    },
    {
      id: "gap",
    ...
    },
    {
      ...
      cssValue: "500",
      tokenName: "--shouf-btn-font-weight",
      category: "typography",
    },
    {
      id: "letter-spacing",
      ...
      cssValue: "-0.01em",
      tokenName: "--shouf-btn-letter-spacing",
      category: "typography",
    },
  ];
}
