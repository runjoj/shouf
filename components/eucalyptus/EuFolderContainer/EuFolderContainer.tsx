...
const LIGHT_P: FolderPalette = {
  cardBg:        "#FFFFFF",
  cardShadow:    "0 1px 4px rgba(0,0,0,0.10), 0 0 0 1px rgba(0,0,0,0.06)",
  selectedBg:    "#E0E5ED",
  ...
  headerColor:   "#949494",
  btnBg:         "#FFFFFF",
  btnShadow:     "0 1px 4px 0 rgba(0,0,0,0.16)",
  menuBg:        "#FFFFFF",
  menuShadow:    "0 4px 20px rgba(0,0,0,0.12), 0 0 0 1px rgba(0,0,0,0.06)",
  menuHover:     "#F3F4F6",
  menuText:      "#3B3B3B",
  dotsMenuBg:    "#E9E9E9",
  iconFill:      "#052942",
  folderDefault: "#D5D6D6",
};

const DARK_P: FolderPalette = {
  cardBg:        "#26292F",
  cardShadow:    "0 1px 4px rgba(0,0,0,0.40), 0 0 0 1px #7A8494",
  selectedBg:    "#343842",
  selectedColor: "#DBE4F2",
  defaultColor:  "#DBE4F2",
  countColor:    "#A6AAB6",
  headerColor:   "#A6AAB6",
  btnBg:         "#343842",
  btnShadow:     "0 1px 4px 0 rgba(0,0,0,0.40), 0 0 0 1px #7A8494",
  menuBg:        "#26292F",
  menuShadow:    "0 4px 20px rgba(0,0,0,0.50), 0 0 0 1px #7A8494",
  menuHover:     "#343842",
  menuText:      "#DBE4F2",
  dotsMenuBg:    "#4E535E",
  iconFill:      "#DBE4F2",
  folderDefault: "#5A6170",
};

// ─── Custom SVG icons (from Figma export) ────────────────────────────────────────
function LightningSvg({ color = "#052942" }: { color?: string }) {
  return (
...
function FolderPlusSvg({ color = "#052942" }: { color?: string }) {
  return (
    <svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M17.1 2H9.5L7.6 0H1.9C0.8455 0 0.00949999 0.89 0.00949999 2L0 14C0 15.11 0.8455 16 1.9 16H17.1C18.1545 16 19 15.11 19 14V4C19 2.89 18.1545 2 17.1 2ZM16.15 10H13.3V13H11.4V10H8.55V8H11.4V5H13.3V8H16.15V10Z" fill={color}/>
    </svg>
  );
}
...
function RowIcon({ type, isSelected, p }: { type: FolderItem["icon"]; isSelected: boolean; p: FolderPalette }) {
  const c = isSelected ? p.selectedColor : p.iconFill;
  switch (type) {
    case "library": return <LibrarySvg color={c} />;
    case "trash":   return <TrashSvg color={c} />;
    default:        return <Folder2Svg selected={isSelected} selectedColor={p.selectedColor} defaultColor={p.folderDefault} />;
  }
}
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "6px" }}>
          ...
          >
            <LightningSvg color={p.iconFill} />
            <FolderPlusSvg color={p.iconFill} />
          </button>
      ...
      <div style={{ padding: "2px 6px 8px", display: "flex", flexDirection: "column", gap: size === "compact" ? "4px" : "6px" }}>
        {FOLDERS.map((f, i) => {
          ...
          const dotsColor   = isSelected ? p.selectedColor : p.defaultColor;
            ...
            <div key={f.id} style={{ position: "relative" }}>
              <button
                ...
                style={{
                  ...
                  backgroundColor: isSelected ? p.selectedBg : "transparent",
                  color:           isSelected ? p.selectedColor : p.defaultColor,
                  borderRadius:    "6px",
                  border:          "none",
                  cursor:          "pointer",
                  fontFamily:      "inherit",
              ...
              >
                ...
                {showIcons && (
                  <span style={{ flexShrink: 0, display: "flex", alignItems: "center" }}>
                    <RowIcon type={f.icon} isSelected={isSelected} p={p} />
                  </span>
                )}
                ...
                <span
                  ...
                  style={{
                    ...
                    fontSize:       "12px",
                    fontWeight:     isSelected ? 600 : 400,
                    color:          isSelected ? p.selectedColor : p.countColor,
                    cursor:         "pointer",
                    padding:        "6px 8px",
                    margin:         "-6px -8px",
                  }}
                  ...
                  {showDots
                    ? (
                      <span style={{
                        ...
                        width:           "20px",
                        height:          "16px",
                        backgroundColor: menuOpen ? p.dotsMenuBg : "transparent",
                        borderRadius:    "4px",
                      }}>
                  ...
                  {MENU_ITEMS.map(({ id, label, Icon }) => (
                    <button
                      ...
                      style={{
                        ...
                        width:           "100%",
                        padding:         "9px 12px",
                        backgroundColor: menuHoverId === id ? p.menuHover : "transparent",
                        border:          "none",
                        borderRadius:    "7px",
                        cursor:          "pointer",
                        fontFamily:      "inherit",
